...
const runCpuInfo = (hostAddress, response) => {
    ...
    var conn = new Client();
    var commandPath = '/home/ubuntu/Git/JsObjects/Utilities/SetupLinuxBox/CpuInfo';
...
router.get('/uptime', (request, response) => {
    console.log('run-uptime called in ssh-runner', hostAddress);
...
router.get('/cpu-info', (request, response) => {
    console.log('run-cpu-info in ssh-runner', hostAddress);
